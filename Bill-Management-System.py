...
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Dosa........Rs.60/plate",fg="black",bg="lightgreen").place(x=10,y=80)
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Cookies........Rs.30/plate",fg="black",bg="lightgreen").place(x=10,y=110)
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Tea........Rs.15/cup",fg="black",bg="lightgreen").place(x=10,y=140)
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Coffee........Rs.20/cup",fg="black",bg="lightgreen").place(x=10,y=170)
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Juice........Rs.60/Glass",fg="black",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Pancakes........Rs.15/pack",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucide Calligraphy",15,"bold"),text="Eggs........Rs.7/egg",fg="black",bg="lightgreen").place(x=10,y=260)
#Bill
...
#Entry Work
f1=Frame(root,bd=5,height=370,width=30,relief=RAISED)
f1.pack()
Dosa=StringVar()
Cookies=StringVar()
Tea=StringVar()
